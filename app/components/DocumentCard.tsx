...
export default function DocumentCard({
  ...
  return (
    <div className="box-border flex flex-col justify-between p-6 m-0 bg-white rounded-lg max-w-[300px]  sm:max-w-none">
      <div className="flex gap-2 items-center">
        ...
        <div className="box-border p-0 m-0  text-lg leading-8 text-neutral-800 text-center sm:text-left mb-0">
          {title}
        </div>
      </div>
      ...
      <div className="box-border flex flex-col sm:flex-row gap-3.5 p-0 m-0 mt-5">
        <a
          href={readLink}
          download
          className="box-border px-2  m-0 py-2 text-lg text-white bg-sky-500 rounded-md cursor-pointer border-[none] min-w-[90px] text-center"
        >
          {downloadLabel}
        </a>
      </div>
