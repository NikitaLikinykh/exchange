...
export default function MediaPage() {
  ...
  const tabs = ["Все", "СМИ о нас", "События", "Акции"];
        ...
        <div className="flex justify-center p-0 mx-auto my-0 bg-[#2B82FF] rounded-lg w-[458px] max-sm:flex-wrap max-sm:h-auto max-sm:w-[90%]">
          {tabs.map((tab) => (
            <div
              ...
              className={`px-6 pt-1.5 pb-2 text-lg font-semibold cursor-pointer max-sm:flex-auto max-sm:px-4 max-sm:py-2 rounded-md ${
